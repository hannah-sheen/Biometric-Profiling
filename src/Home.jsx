...
function Home() {
  ...
  const handleScanFace = () => {
    navigate('/capture-face');  // Navigate to CreateProfile when the button is clicked
  };
  ...
  return (
    <div className="flex justify-center items-center">
      <div className="bg-white rounded-lg drop-shadow-md h-[500px] w-[600px] mt-[9rem]">
        ...
        <div>
          <button className="h-[100px] w-[400px] border-2 border-custom-blue rounded-lg flex items-center justify-center ml-[100px] mt-[0rem]" onClick={handleScanFace}>
            <img src={faceId} alt="Fingerprint" className="h-[4.5rem] max-w-full object-contain mr-[1rem]" />
            <p className='text-[22px] text-custom-grey2 pl-[1rem] font-montserrat'>Scan My Face</p>
          </button>
