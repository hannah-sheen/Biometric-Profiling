       ...
       <div className="pb-9 pr-9 w-[90rem] flex-shrink-0">
        ...
        <div className="bg-txt-color rounded-lg shadow-lg pl-9 pb-9 pr-9 w-[90rem] flex-shrink-0">
            ...
            {/* Left Column: Add Photo */}
                <div className="flex flex-col items-center mt-[2.5rem] ml-[-1rem]">
    ...
    <div id='mother-info'>
     <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-6">
        ...
        <div className="flex justify-end m-[2rem]">
            <button className="w-[100px] h-[40px] bg-green-600 font-montserrat text-white text-[15px] rounded-md drop-shadow-md hover:bg-green-700 transition duration-200">Save</button>
            <button className="w-[100px] h-[40px] bg-red-900 font-montserrat text-white text-[15px] rounded-md ml-4 drop-shadow-md hover:bg-red-800 transition duration-200">Cancel</button>
        </div>
